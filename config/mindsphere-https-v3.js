  ...
  return new Promise(function(resolve, reject) {
    if (typeof answer.statusCode !== 'undefined') {
      ...
      if (error) {
        ...
        console.log('Answer ' + answer.statusCode)
...
exports.get_token = function(params){
  ...
  return new Promise(function(resolve, reject){
    ...
    if (typeof params.baseURL === 'undefined') { reject({answer: null, body: 'baseURL', error: 'Input Error'}) }
    ...
    httpsRequest.get({
            url: params.baseURL + '/oauth/token?grant_type=client_credentials',
            headers: {
...
exports.put_asset = function(params){
  ...
  return new Promise(function(resolve, reject){
    ...
    if (typeof params.name !== 'undefined') { assetbody.name = params.name }
    if (typeof params.description !== 'undefined') { assetbody.description = params.description }

    var path = '/api/assetmanagement/v3/assets/' + params.assetId;
